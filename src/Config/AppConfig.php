...
class AppConfig
{
    ...
    public static function getViewTokens(): array
    {
        return [
            ...
            'bg_light'        => self::get('ui.colors.bg_light'),
            'surface_light'   => self::get('ui.colors.surface_light'),
            ...
            'gold_color'      => self::get('ui.colors.gold'),
            'color_success'   => self::get('ui.colors.success'),
            'color_warning'   => self::get('ui.colors.warning'),
